...
package com.cuttlefish.runtime{
	...
	public class LispNamespace implements IHashable{
		...
		public static var CUTTLEFISH_NAMESPACE_NAME:String = "cuttlefish";
		...
		public static function remove(rt:RT, name:Symbol):LispNamespace{
			if(name.getName() == CUTTLEFISH_NAMESPACE_NAME)
			throw new Error("IllegalArgumentException: Cannot remove cuttlefish namespace");
			var ns:LispNamespace  = LispNamespace(rt.namespaces.valAt(name));
