...
package com.cuttlefish.runtime{
	...
	import com.cuttlefish.runtime.LispNamespace;
	import com.cuttlefish.runtime.Var;
	import com.cuttlefish.runtime.Frame;
	...
	public class RT extends EventDispatcher{
		...
		[Embed(source="../../../../ctl/boot.ctl", mimeType="application/octet-stream")]
		protected const BootCtl:Class;
		public var BOOT_CTL:String = (ByteArray(new BootCtl).toString());
		...
		public var CUTTLEFISH_NAMESPACE:LispNamespace;
		...
		public function RT(stage:Stage = null, out:OutputStream = null, err:OutputStream = null, inn:InputStream = null):void{
			...
			CUTTLEFISH_NAMESPACE = LispNamespace.findOrCreate(this, sym1(LispNamespace.CUTTLEFISH_NAMESPACE_NAME));
			CURRENT_NS = Var.internWithRoot(CUTTLEFISH_NAMESPACE, sym1("*ns*"), CUTTLEFISH_NAMESPACE);
			RUNTIME = Var.internWithRoot(CUTTLEFISH_NAMESPACE, sym1("*runtime*"), this);
			STAGE = Var.internWithRoot(CUTTLEFISH_NAMESPACE, sym1("*stage*"), _stage);
			OUT = Var.internWithRoot(CUTTLEFISH_NAMESPACE, sym1("*out*"), stdout);
			IN = Var.internWithRoot(CUTTLEFISH_NAMESPACE, sym1("*in*"), stdin);
			OUT = Var.internWithRoot(CUTTLEFISH_NAMESPACE, sym1("*err*"), stderr);
			PRINT_READABLY = Var.internWithRoot(CUTTLEFISH_NAMESPACE, sym1("*print-readably*"), T);
			SAVE_BYTECODES = Var.internWithRoot(CUTTLEFISH_NAMESPACE, sym1("*save-bytecodes*"), F);
			...
			*/
			...
			Var.internWithRoot(CUTTLEFISH_NAMESPACE, IN_NAMESPACE, 
				function(nsname:Symbol):LispNamespace{
					var ns:LispNamespace = LispNamespace.findOrCreate(_this, nsname);
					CURRENT_NS.set(ns);
					return ns;
				});
			IN_NAMESPACE = sym2(LispNamespace.CUTTLEFISH_NAMESPACE_NAME, "in-ns");

			LOAD_FILE = sym1("load-file");
			Var.internWithRoot(CUTTLEFISH_NAMESPACE, LOAD_FILE,
				function(arg1:Object):Object{
					//return Compiler.loadFile(String(arg1));
					return null;
				});
			LOAD_FILE = sym2(LispNamespace.CUTTLEFISH_NAMESPACE_NAME, "load-file");

			IDENTICAL = sym1("identical?");
			Var.internWithRoot(CUTTLEFISH_NAMESPACE, IDENTICAL,
				function(arg1:Object, arg2:Object):Object{
					return arg1 == arg2 ? RT.T : RT.F;
				});
			IDENTICAL = sym2(LispNamespace.CUTTLEFISH_NAMESPACE_NAME, "identical?");

			CONCAT = sym1("concat");
			Var.internWithRoot(CUTTLEFISH_NAMESPACE, CONCAT,
				function(...args:Array):Object{
					return RT.concat.apply(null, args);
				});
			CONCAT = sym2(LispNamespace.CUTTLEFISH_NAMESPACE_NAME, "concat");

			APPLY = sym1("apply*");
			Var.internWithRoot(CUTTLEFISH_NAMESPACE, APPLY,
				function(func:Function, args:ISeq):Object{
					var ar:Array = [];
					for(var c:ISeq = args; c != null; c = c.rest()){ ar.push(c.first()); }
					return func.apply(null, ar);
				});
			APPLY = sym2(LispNamespace.CUTTLEFISH_NAMESPACE_NAME, "apply*");

			VECTOR = sym1("vector");
			Var.internWithRoot(CUTTLEFISH_NAMESPACE, VECTOR,
				function(...args:Array):Object{
					return Vector.createFromArray(args);
				});
			VECTOR = sym2(LispNamespace.CUTTLEFISH_NAMESPACE_NAME, "vector");

			HASHMAP = sym1("hash-map");
			Var.internWithRoot(CUTTLEFISH_NAMESPACE, HASHMAP,
				function(...args:Array):Object{
					return Map.createFromArray(args);
				});
			HASHMAP = sym2(LispNamespace.CUTTLEFISH_NAMESPACE_NAME, "hash-map");

			LIST = sym1("list");
			Var.internWithRoot(CUTTLEFISH_NAMESPACE, LIST,
				function(...args:Array):Object{
					return List.createFromArray(args);
				});
			LIST = sym2(LispNamespace.CUTTLEFISH_NAMESPACE_NAME, "list");


			WITH_META = sym1("with-meta");
			Var.internWithRoot(CUTTLEFISH_NAMESPACE, WITH_META,
				function(x:Object, m:Object):Object{
					return x.withMeta(m);
				});
			WITH_META = sym2(LispNamespace.CUTTLEFISH_NAMESPACE_NAME, "with-meta");

			META = sym2(LispNamespace.CUTTLEFISH_NAMESPACE_NAME, "meta");

			DEREF = sym2(LispNamespace.CUTTLEFISH_NAMESPACE_NAME, "deref");
			...
			NEW = sym1("new");
			_AMP_ = sym1("&");
			ISEQ = sym1("com.cuttlefish.runtime.ISeq");
		...
		public function loadStdLib(onComplete:Function = null, progress:Function = null, failure:Function = null):void{
			evalStr(BOOT_CTL, onComplete, progress, failure);
		}
