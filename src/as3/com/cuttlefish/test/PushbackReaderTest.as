...
package com.cuttlefish.test{
	...
	import flash.utils.*;
	import com.cuttlefish.jdk.io.StringReader;
	import com.cuttlefish.jdk.io.PushbackReader;

	public class PushbackReaderTest extends RichTestCase {
		...
		public function testCreate():void{
			var s:PushbackReader = new PushbackReader(new StringReader("hello"));
		}
		...
		public function testUnreadingArrayOfChars():void{
			var s:PushbackReader = new PushbackReader(new StringReader("hello"), 2);
			assertTrue("first character should be 'h'", String.fromCharCode(s.readOne()) == "h");
			var a:int = s.readOne();
			var b:int = s.readOne();
			s.unreadArray([a,b]);
