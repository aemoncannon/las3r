...
package com.cuttlefish.test{
	...
	import com.cuttlefish.errors.*;
	import com.cuttlefish.util.*;

	public class CompilerTest extends CUTTLEFISHTest {
		...
		public function testBindBirdToTrue():void{
			readAndLoad("(def *bird* true)",
				function(rt:RT, val:*):void{
					...
					var v:Var = rt.getVar("cuttlefish", "*bird*");
		...
		public function testBindBirdToAS3Class():void{
			readAndLoad("(def *bird* com.cuttlefish.runtime.Vector)",
				function(rt:RT, val:*):void{
					var v:Var = rt.getVar("cuttlefish", "*bird*");
			...
			readAndLoad("(def *funA* (fn* [a] (fn* [] a)))", function(rt:RT, val:*):void{
					readAndLoad("(def *funB* (*funA* :bird))", function(rt:RT, val:*):void{
							readAndLoad("(def *result* (*funB*))", function(rt:RT, val:*):void{
									var v:Var = rt.getVar("cuttlefish", "*result*");
		...
		public function testGetStaticField():void{
			readAndLoad("(def *bird* (. com.cuttlefish.test.CompilerTest name))", function(rt:RT, val:*):void{
					var v:Var = rt.getVar("cuttlefish", "*bird*");
		...
		public function testAssignToStaticFieldThenGet():void{
			readAndLoad("(set! (. com.cuttlefish.test.CompilerTest name) \"jack\")", function(rt:RT, val:*):void{
					readAndLoad("(def *bird* (. com.cuttlefish.test.CompilerTest name))", function(rt:RT, val:*):void{
							var v:Var = rt.getVar("cuttlefish", "*bird*");
		...
		public function testGetInstanceField():void{
			readAndLoad("(def *bird* (. (if true com.cuttlefish.test.CompilerTest) name))", function(rt:RT, val:*):void{
					var v:Var = rt.getVar("cuttlefish", "*bird*");
					assertTrue("*bird* should be bound to 'joe'", v.get() == "joe");
				});
		}
		...
		public function testAssignToInstanceFieldThenGet():void{
			readAndLoad("(set! (. (if true com.cuttlefish.test.CompilerTest) name) \"jack\")", function(rt:RT, val:*):void{
					readAndLoad("(def *bird* (. (if true com.cuttlefish.test.CompilerTest) name))", function(rt:RT, val:*):void{
							var v:Var = rt.getVar("cuttlefish", "*bird*");
							assertTrue("*bird* should be bound to 'jack'", v.get() == "jack");
						}, rt);
		...
		public function testCallInstanceMethodWithNoArgs():void{
			readAndLoad("(def *bird* (. (if true com.cuttlefish.test.CompilerTest) (getName)))", function(rt:RT, val:*):void{
					var v:Var = rt.getVar("cuttlefish", "*bird*");
					assertTrue("*bird* should be bound to 'joe'", v.get() == "joe");
				});
		}
		...
		public function testCallInstanceMethod():void{
			readAndLoad("(def *bird* (. (if true com.cuttlefish.test.CompilerTest) (echo \"jack\")))", function(rt:RT, val:*):void{
					var v:Var = rt.getVar("cuttlefish", "*bird*");
					assertTrue("*bird* should be bound to 'jack'", v.get() == "jack");
				});
		}
		...
		public function testVarLiteralExpression():void{
			readAndLoad("(def *dude* 1)", function(rt:RT, val:*):void{
					readAndLoad("(def *bird* (var *dude*))", function(rt:RT, val:*):void{
							var v:Var = rt.getVar("cuttlefish", "*bird*");
							assertTrue("*bird* should be bound to *dude*", v.get() == rt.getVar("cuttlefish", "*dude*"));
						}, rt);
				});
		}
		...
		public function testBasicSyntaxQuotedList():void{
			readAndLoad("`(a b c)",
				function(rt:RT, val:*):void{
					var ns:String = LispNamespace.CUTTLEFISH_NAMESPACE_NAME;
