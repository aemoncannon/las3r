...
package com.las3r.runtime{
	...
	public class Compiler{
		...
		public function Compiler(rt:RT){
			...
			SOURCE = new Var(_rt, null, null, "UNKNOWN_SOURCE");
		...
		private function analyzeSeq(context:C, form:ISeq , name:String ):Expr {
			...
			if(RT.meta(form) != null && RT.meta(form).containsKey(_rt.LINE_KEY)){
				line = (Integer) RT.meta(form).valAt(_rt.LINE_KEY);
			}
			...
			catch(e:*)
			{
				...
				throw new CompilerException(SOURCE.get() + ":" + int(LINE.get()) + ": " + e.message), e);
				else
